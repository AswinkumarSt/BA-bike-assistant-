...
class Bobber42Page extends StatefulWidget {
  const Bobber42Page({super.key});

  @override
  State<Bobber42Page> createState() => _Bobber42PageState();
}

class _Bobber42PageState extends State<Bobber42Page> {
  final List<String> slideshowImages = [
    'assets/icons/jawa_1.avif', // Replace with actual 42 Bobber image paths
    'assets/icons/jawa_2.jpg',
    'assets/icons/jawa_3.jpg',
  ];
  ...
  final List<Map<String, String>> tutorials = [
    {
      ...
      'description':
          'Smooth rotation of the front wheel of your 42 Bobber depends how well you maintain its axle.',
      'videoId': 'Kk-Ka68wZt4',
    },
    {
      'title': 'Oil Change Tutorial',
      'description':
          'Learn how to change the engine oil for your 42 Bobber for smooth performance.',
      'videoId': 'CK3BNgcaM1g',
    },
    {
