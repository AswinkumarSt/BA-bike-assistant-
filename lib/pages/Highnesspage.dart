...
class HighnessPage extends StatefulWidget {
  const HighnessPage({super.key});

  @override
  State<HighnessPage> createState() => _HighnessPageState();
}

class _HighnessPageState extends State<HighnessPage> {
  final List<String> slideshowImages = [
    'assets/icons/highness_1.jpg', // Replace with your actual image paths
    'assets/icons/highness_2.jpg',
    'assets/icons/highness_3.jpg',
  ];
  ...
  final List<Map<String, String>> tutorials = [
    {
      ...
      'description':
          'Smooth rotation of the front wheel of your Highness depends how well you maintain its axle.',
      'videoId': 'Kk-Ka68wZt4',
    },
    {
      'title': 'Oil Change Tutorial',
      'description':
          'Learn how to change the engine oil for your Highness for smooth performance.',
      'videoId': 'CK3BNgcaM1g',
    },
    {
