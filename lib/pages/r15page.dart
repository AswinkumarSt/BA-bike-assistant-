...
class R15Page extends StatefulWidget {
  @override
  State<R15Page> createState() => _R15PageState();
}

class _R15PageState extends State<R15Page> {
  final List<String> slideshowImages = [
    'assets/icons/r15_1.jpg', // Replace with actual R15 image paths
    'assets/icons/r15_2.jpg',
    'assets/icons/r15_3.jpg',
  ];
  ...
  final List<Map<String, String>> tutorials = [
    {
      ...
      'description':
          'Learn how to change the engine oil for your Yamaha R15 for smooth performance.',
      'videoId': 'CK3BNgcaM1g',
    },
    {
    ...
    },
    {
      ...
      'description':
          'Smooth rotation of the front wheel of your Yamaha R15 depends how well you maintain its axle.',
      'videoId': 'IZN3rOfQwFk',
    },
    {
